...
# ══════════════════════════════════════════════════════════════════════════════
# ══════════════════════════════════════════════════════════════════════════════
# CONFIGURACIÓN — cambia esta variable para apuntar a tu archivo
# ══════════════════════════════════════════════════════════════════════════════
CSV_PATH = 'lf_traj_1780173930.csv'   # Ejemplo: 'lf_traj_1780173930.csv'
                # Dejar vacío ('') para tomar el archivo más reciente

if __name__ == '__main__':
    path = CSV_PATH if CSV_PATH else _latest()
