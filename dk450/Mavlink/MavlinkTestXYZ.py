...
parser.add_argument('--origin-lon', type=float, default=-99.227935)    #-99.2280871)
parser.add_argument('--origin-alt', type=float, default=2340.0)
parser.add_argument('--calib-mode', choices=['enu','angle','pair'], default='enu')
...
parser.add_argument('--alt-mode', choices=['ned','computed','lidar'], default='computed', help="Altura a mostrar")
