#!/usr/bin/env python3
"""
Replay RViz2 — generado desde lf_circulo_1779860536.csv
==========================================
Publica:
  /leader/path          nav_msgs/Path
  /follower/path        nav_msgs/Path
  /follower/setpoint    nav_msgs/Path
  /formation/marker     visualization_msgs/MarkerArray

Uso:
  ros2 run tf2_ros static_transform_publisher 0 0 0 0 0 0 map odom
  python3 lf_circulo_1779860536_rviz_replay.py
  rviz2
"""
...
CSV_FILE = "lf_circulo_1779860536.csv"
FRAME_ID = "map"
SPEED    = 1.0
...
def main():
    ...
    print(f"Duración: {float(rows[-1]['t']):.1f} s")
    rclpy.init()
